...
if Gallons_of_water_used2 <= 4000000:
    print("Gallons of water used: ", round(Gallons_of_water_used2,2))
    first_amount2 = 1000.00
    #second_amount2 = 0.00025*Gallons_of_water_used2
    amount2 = first_amount2#+second_amount2
    print("Amount billed: $", round(first_amount2,2))
elif (Gallons_of_water_used2 > 4000000) and (Gallons_of_water_used2 <= 10000000) :
    print("Gallons_of_water_used: ", Gallons_of_water_used2)
    amount2 = 2000.00
    print("Amount billed: $",amount2)
elif Gallons_of_water_used2 > 10000000:
    print("Gallons_of_water_used: ", Gallons_of_water_used2)
